...
class Dom {
    ...
    // Lấy source HTML của url
    // Truyền vào đường dẫn url và lấy được HTML source
    public function get_source($url, $post = null, $cookies = array(), $agent = 'Googlebot/2.1 (+http://www.google.com/bot.html)') {
        $ch = curl_init($url);
        ...
        curl_setopt($ch, CURLOPT_REFERER, '[url=http://www.google.com]http://www.google.com[/url]');
    ...
    public function get_dom($url, $post = false, $cookies = array()) {
        $html = new simple_html_dom();
        $html->load($this->get_source($url, $post, $cookies));
        return $html;
    }

    public function to_dom($str) {
