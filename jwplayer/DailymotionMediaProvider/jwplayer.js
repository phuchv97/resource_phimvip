                ...
                for (var P = 0; P < Q.length; P++) {
                    ...
                    if (c.exists(C.plugins.object[T].getDisplayElement)) {
                        if (C.plugins.config[T].currentPosition != a.html5.view.positions.NONE) {
                            ...
                            b(C.plugins.object[T].getDisplayElement(), {
                                display: "none"
                            })
                        }
                    }
        ...
        b.html5.mediavideo = function (h, F) {
            ...
            this.load = function (V, W) {
                ...
                if (W) {
                    ...
                    s(b.api.events.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 0
                    });
                    A()
                }
            ...
            this.volume = function (U) {
                if (!a) {
                    m.volume = U / 100;
                    s(b.api.events.JWPLAYER_MEDIA_VOLUME, {
                        volume: (U / 100)
                    })
                }
            };
            this.mute = function (U) {
                if (!a) {
                    m.muted = U;
                    s(b.api.events.JWPLAYER_MEDIA_MUTE, {
                        mute: U
                    })
                }
            };
            ...
            function w(U) {
                ...
                if (f != U) {
                    var V = f;
                    j.state = f = U;
                    s(b.api.events.JWPLAYER_PLAYER_STATE, {
                        oldstate: V,
                        newstate: U
                    })
                }
            ...
            function D(W) {
                ...
                if (e.useNativeFullscreen() && e.exists(m.webkitDisplayingFullscreen)) {
                    if (j.fullscreen != m.webkitDisplayingFullscreen) {
                        s(b.api.events.JWPLAYER_FULLSCREEN, {
                            fullscreen: m.webkitDisplayingFullscreen
                        }, true)
                    }
                }
            ...
            function N(V) {
                ...
                if (e.exists(V) && e.exists(V.target)) {
                    ...
                    if (f == b.api.events.state.PLAYING) {
                        ...
                        s(b.api.events.JWPLAYER_MEDIA_TIME, {
                            position: j.position,
                            duration: j.duration
                        });
            ...
            function u(V) {
                ...
                s(b.api.events.JWPLAYER_MEDIA_META, {
                    metadata: W
                })
            }
            function o(W) {
