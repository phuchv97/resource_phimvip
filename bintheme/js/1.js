        ...
        afterAjaxLoad = function() {
            ...
            $('.input-search', bodyTag).each(function() {
                ...
                var search_options = {
                    ...
                    deferRequestBy: 0,
                    type: 'POST',
                    serviceUrl: Base + 'ajax/search.php',
                    dataType: 'json',
    ...
    $.ajax({
        ...
        function i() {
            ...
            "" != i && $.trim($("#tukhoaiphim").val()).length >= 1 ? (key = t(i), $(".autocomplete-suggestions").html(''), $(".autocomplete-suggestions").css("display", "block"), $.ajax({
                type: "POST",
                url: "https://iphimhd.com/search.php",
                data: "key=" + i,
                success: function(t) {
        ...
        $("#tukhoaiphim").keyup(function(t) {
            e(function() {
                i()
            }, 500), 13 == t.which && (value = $("#tukhoaiphim").val(), site_url = "https://iphimhd.com", link_search = site_url + "/search/" + value, window.location.replace(link_search))
        })
